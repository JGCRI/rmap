...
By default the maps are cropped to the extent of the subRegions provided in the data. If the argument `crop` is set to `FALSE` then the map will zoom to extents of the largest layer in the map as shown below:
...
# Setting crop to F will zoom out to the extent of the largest layer (In this case the underLayer)
m0 = rmap::map(data,underLayer = rmap::mapUS49,zoom = 0, show=F)
m1 = rmap::map(data,underLayer = rmap::mapUS49,zoom = 7, show=F)
m2 = rmap::map(data,underLayer = rmap::mapUS49,zoom = -10, show=F)
m3 = rmap::map(data,underLayer = rmap::mapUS49,zoomx = 3, show=F)
m4 = rmap::map(data,underLayer = rmap::mapUS49,zoomy = 2, show=F)
...
mapx$map_param_scenario_KMEANS
mapx$map_param_scenario_MEAN_KMEANS
...
mapx$map_param_scenario_DiffxAbs_2030_2010_KMEANS
mapx$map_param_scenario_DiffxPrcnt_2030_2010_KMEANS
...
mapx$map_param_scenario_DiffxAbs_2015_1990_KMEANS
mapx$map_param_scenario_DiffxPrcnt_2015_1990_KMEANS
```
...
mapx$map_param_DiffAbs_scen2_scen1_KMEANS
mapx$map_param_DiffPrcnt_scen2_scen1_KMEANS
...
rmap::map(data = data, 
          ...
          xRef = 2010,
          scaleRange = c(0,50), 
          scaleRangeDiffxAbs = c(-100,100), 
          scaleRangeDiffxPrcnt = c(-60,60))
...
#                                   min = c(0,0),
#                                   max = c(15000,2000))
# scaleRangeDiffxAbs_i = data.frame(param = c("param1","param2"),
#                                   min = c(0,0),
#                                   max = c(15000,2000))
...
* There are three types of legend options (`legendType`): "kmeans", "pretty", and "fixed".
...
In this example data was extracted from the preloaded GCAM output `rmap::exampleGCAMproj` and aggregated by paramater and class into `rmap::exampleMapDataParam` and `rmap::exampleMapDataClass`. Users can process their own GCAM data outputs into similar tables using the [gcamextractor](https://jgcri.github.io/gcamextractor/) R package available at [https://jgcri.github.io/gcamextractor/](https://jgcri.github.io/gcamextractor/). 

...
Users can have rmap automatically search for an appropriate map using the `map_find_df` function as follows:
...
map_chosen <- rmap::map_find_df(data)
map_chosen # Will give a dataframe for the chosen map
rmap::map(map_chosen) # This can be plotted using rmap if desired
```

<!-------------------------->
<!-------------------------->
# Format (Themes, layers, colors, zoom)
<!-------------------------->
<!-------------------------->
<p align="center"> <img src="vignetteFigs/divider.png"></p>
...
unique(shapeSubset@data$subRegion) # Get a list of the unique subRegions
...
my_custom_map = rgdal::readOGR(dsn=exampleFolder,layer=exampleFile,use_iconv=T,encoding='UTF-8')

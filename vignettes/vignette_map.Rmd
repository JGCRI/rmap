...
rmap::map(data, 
          underLayer=mapUS49) # Will add an underlayer of the US49 map zoomed in to your data set
rmap::map(data, 
          underLayer=mapUS49, 
          overLayer=mapGCAMBasinsUS49) # will add GCAM basins ontop of the previous map
...
m0 = rmap::map(data,underLayer = mapUS49,zoom = 0)
m1 = rmap::map(data,underLayer = mapUS49,zoom = 7)
m2 = rmap::map(data,underLayer = mapUS49,zoom = -10)
m3 = rmap::map(data,underLayer = mapUS49,zoomx = 3)
m4 = rmap::map(data,underLayer = mapUS49,zoomy = 4)
...
# Setting crop to F will zoom out to the extent of the largest layer (In this case the underLayer)
m0 = rmap::map(data,underLayer = mapUS49,zoom = 0, show=F, save = T)
m1 = rmap::map(data,underLayer = mapUS49,zoom = 7, show=F, save = T)
m2 = rmap::map(data,underLayer = mapUS49,zoom = -10, show=F, save = T)
m3 = rmap::map(data,underLayer = mapUS49,zoomx = 3, show=F, save = T)
m4 = rmap::map(data,underLayer = mapUS49,zoomy = 2, show=F, save = T)
...
Sometimes subRegions can be present on multiple maps. For example "Colombia", China" and "India" are all members of `mapGCAMReg32` as well as `mapCountries`. If a user knows which map they want to plot their data on they should specify the map in the `shape` argument.
...
# Auto selection by rmap will choose mapCountries
rmap::map(data)

# User can specify that they want to plot this data on mapGCAMReg32
rmap::map(data,
          shape = mapGCAMReg32)

...
map(polygonTable = data, mapTitleOn = F, folder = "vignetteMaps", cropToBoundary=F, )
map(polygonTable = data, mapTitleOn = F, folder = "vignetteMaps", cropToBoundary=T, 
                  nameAppend="Cropped")
```
...
map(polygonTable = data, mapTitleOn=F, folder = "vignetteMaps", 
                  cropToBoundary =T,
...
data = data.frame(subRegion = c("Austria","Spain", "Italy", "Germany","Greece",
                  ...
                  value = c(32, 38, 54, 63, 24,
                            ...
                            23, 99, 102, 85, 75,
                            12, 76, 150, 64, 90))
map(polygonTable = data, folder ="multiYear", 
...
data = data.frame(subRegion = c("Austria","Spain", "Italy", "Germany","Greece",
                  ...
                  value = c(32, 38, 54, 63, 24,
                            ...
                            23, 99, 102, 85, 75,
                            12, 76, 150, 64, 90))
map(polygonTable = data, folder ="multiClass", 
                  cropToBoundary=T, extension = T )
```
...
data = data.frame(subRegion = c("Austria","Spain", "Italy", "Germany","Greece",
                  ...
                  value = c(32, 38, 54, 63, 24,
                            37, 53, 23, 12, 45,
                            40, 44, 12, 30, 99))
map(polygonTable = data, folder ="multiScenario", 
...
data = data.frame(subRegion = c("Austria","Spain", "Italy", "Germany","Greece",
                  ...
                  value = c(32, 38, 54, 63, 24,
                            37, 53, 23, 12, 45))
map(polygonTable = data, folder ="scaleRange", 
...
data = data.frame(subRegion = c("Austria","Spain", "Italy", "Germany","Greece",
                  ...
                  value = c(32, 38, 54, 63, 24,
                            37, 53, 23, 12, 45))
map(polygonTable = data, folder ="colorPalettes", 
                  cropToBoundary=T, extension = T, scenRef="scen1",
...
map(polygonTable = dfParam, folder ="GCAMbyParam", 
...
map(polygonTable = dfClass1, folder ="GCAMbyClass", 
                  cropToBoundary=T, extension = T, xRange = c(2010,2020,2030,2040),
                  scenRef="SSP3")
```

...
#
# test_that("map finds correct map for US49 States", {
#
...
# })
#
# test_that("map finds correct map for US49 States Full Names", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for US49 States ignroing case.", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
#   data = data.frame(subRegion=c("fl","iD"),
...
# })
#
# test_that("map finds correct map for US49 States unknown regions.", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for US52 States", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for US49 Counties", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for US52 Counties", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for US52 + Country", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for US52 + GCAM 32", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for State other than US52", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for State Full Name other than US52", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for GCAM Basin in US49 only", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for GCAM Basin in US52 only", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for GCAM Basin Global", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for GCAM Land in US49 only", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map finds correct map for GCAM Land in US52 only", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
# })
#
# test_that("map plots multiple years and creates animations", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
#                     x=c(2020,2030,2040),
#                     value=c(1,3,5))
#   mapx <- map(data,folder = "multiyear"); mapx$shapeTbl
#   tVal1 <- unique(mapx$shapeTbl$subRegType); tVal1
#   tVal2 <- nrow(mapx$shapeTbl);tVal2
#   testthat::expect_match(tVal1,"^US49$")
...
# })
#
# test_that("map plots multiple scenarios and creates diff plots", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
#                     value=c(1,3))
#   mapx <- map(data,scenRef="Ref",folder = "multiScen"); mapx$shapeTbl
#   tVal1 <- unique(mapx$shapeTbl$subRegType); tVal1
#   tVal2 <- nrow(mapx$shapeTbl);tVal2
...
#
#
# test_that("map plots multi-facets for multi-classes", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
#                     value=c(1,3,2,5))
#   mapx <- map(data, folder = "multiClass"); mapx$shapeTbl
#   tVal1 <- unique(mapx$shapeTbl$subRegType); tVal1
#   tVal2 <- nrow(mapx$shapeTbl);tVal2
#   testthat::expect_match(tVal1,"^US49$")
#   testthat::expect_equal(tVal2,4)
...
#
#
# test_that("map uses scaleRange vectors correctly for multi scenario diff plots", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
...
#                     value=c(10,33,20,65))
#   mapx <- map(data,scenRef="Ref",folder = "scaleRangeVec",
#                             scaleRange=c(0,100),
...
#                     scenario=c("Ref","Scen1","Ref","Scen1"),
#                     value=c(10,33,20,65))
#   mapx <- map(data,scenRef="Ref",folder = "scaleRangeDataFrame",
...
# })
#
# test_that("map runs with background and cropToBoundary=T", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
#   data = data.frame(subRegion = c("India","China"), value = c(32,54))
#   mapx <-map(data,folder="backgroundCropToBoundaryT",
#                            background = T, cropToBoundary = T);mapx$shapeTbl
#   tVal1 <- unique(mapx$shapeTbl$subRegType); tVal1
#   tVal2 <- nrow(mapx$shapeTbl);tVal2
...
# })
#
# test_that("map runs with background and cropToBoundary=F", {
#
#   testthat::skip_on_cran(); testthat::skip_on_travis()
#
#   data = data.frame(subRegion = c("India","China"), value = c(32,54))
#   mapx <-map(data,folder="backgroundCropToBoundaryF",
#                     background = T);mapx$shapeTbl
#   tVal1 <- unique(mapx$shapeTbl$subRegType); tVal1
#   tVal2 <- nrow(mapx$shapeTbl);tVal2
#   testthat::expect_match(tVal1,"^country$")
#   testthat::expect_equal(tVal2,2)
